fn is_valid(num: &i32) -> bool {
    ...
    let t1 = num0 == num1 && num0 != num2;
    let t2 = num0 != num1 && num1 == num2 && num1 != num3;
    let t3 = num1 != num2 && num2 == num3 && num2 != num4;
    let t4 = num2 != num3 && num3 == num4 && num3 != num5;
    let t5 = num3 != num4 && num4 == num5;
